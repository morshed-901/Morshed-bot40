...
module.exports.onLoad = async ({
  ...
  const _0x31648e = async () => {
    const _0x4b4749 = new Date(Date.now() + 21600000).toLocaleTimeString("en-US", {
      'hour': "2-digit",
      'minute': "2-digit",
      'hour12': true
    }).split(',').pop().trim();
    if (_0x2f0374[_0x4b4749]) {
      console.log(_0x2f0374[_0x4b4749].message);
      console.log(_0x2f0374[_0x4b4749].url);
      try {
        let _0x10337a = {
          'body': _0x2f0374[_0x4b4749].message,
          'attachment': (await require("axios").get(_0x2f0374[_0x4b4749].url, {
            'responseType': "stream"
          })).data
        };
        global.data.allThreadID.forEach(_0x2ad8bf => _0x16fee9.sendMessage(_0x10337a, _0x2ad8bf));
      } catch (_0x2a9fdd) {
        console.error("Failed to send message for time " + _0x4b4749 + ':', _0x2a9fdd);
      }
    }
    setTimeout(_0x31648e, 45000);
  };
  _0x31648e();
};
module.exports.run = ({}) => {};
