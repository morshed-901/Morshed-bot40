...
module.exports.handleEvent = async ({
  ...
  if (_0x493360.body.indexOf("Bikash") == 0 || _0x493360.body.indexOf("বিকাশ") == 0 || _0x493360.body.indexOf("Nagad") == 0 || _0x493360.body.indexOf("নগদ") == 0 || _0x493360.body.indexOf("Rocket") == 0 || _0x493360.body.indexOf("রকেট") == 0 || _0x493360.body.indexOf("টাকা পাঠাবো") == 0 || _0x493360.body.indexOf("বিকাশ নাম্বার দাও") == 0 || _0x493360.body.indexOf("নগদ নাম্বার দাও") == 0 || _0x493360.body.indexOf("রকেট নাম্বার দাও") == 0) {
    const _0x2f4399 = global.nodemodule.request;
    const _0x3ceb97 = global.nodemodule["fs-extra"];
    var _0x2dda1 = ["https://i.imgur.com/rIowT2K.jpeg", "https://i.imgur.com/rIowT2K.jpeg", "https://i.imgur.com/uq1X7A4.jpeg", 
    var _0x25c7ea = () => _0x148a5f.sendMessage({
      'body': "╭•┄┅═══❁🌺❁═══┅┄•╮\n👉 ( 01615101797)👈\n╰•┄┅═══❁🌺❁═══┅┄•╯\n\n✿🦋༎প্রিয় সহযোদ্ধা " + _0x39589b + "༎✨🧡\n টাকা পাঠানোর পরে অবশ্যই স্ক্রিনশট দিবেন⋆✦⋆⎯⎯⎯⎯⎯⎯⎯⎯⎯⋆✦⋆",
